...
echo ""
echo "[3/7] Preparando datos (train/test split)..."
python3 prepare_data.py

# 4. Limpiar features redundantes
echo ""
echo "[4/7] Limpieza de features redundantes..."
python3 feature_cleaning.py

# 5. Preprocesar datos
echo ""
echo "[5/7] Preprocesando datos (encoding, scaling)..."
python3 preprocess_data.py

# 6. Tain baseling y analisis de cohortes
echo ""
echo "[6/7] Entrenando baseline y analizando cohortes..."
python3 train_baseline.py
python3 analyze_cohorts.py

#7. Incorporacion de datos nuevos y aumentacion
echo ""
echo "[7/7] Entrenando baseline y analizando cohortes..."
